...
s ssk.gem:add( eventName, handler [ , group ] )
...
d can be used as shorthand for it if you like.
s ssk.gem:remove( eventName, handler )
s * eventName - A string containing the name of the event to add (register).
s * handler - The handle to a function which will process the event when it occurs.
r None.
e local fuction myHandler( event )
...
--[[
h ssk.gem:removeGroup
d Automatically un-registers all handlers and event previously registered with ssk.gem:add() using a named ''group''.
s ssk.gem:removeGroup( group )
...
--[[
h ssk.gem:removeAll
d Automatically un-registers all non-grouped handlers and event previously that were registered with ssk.gem:add().
s ssk.gem:removeAll( )
r None.
e local fuction myHandler( event )
e end
...
d can be used as shorthand for it if you like.
s ssk.gem:post( eventName [ , eparams ] )
