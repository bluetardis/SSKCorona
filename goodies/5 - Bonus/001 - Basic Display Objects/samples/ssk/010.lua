...
ssk.labels:quickLabel( group, "quick label #1", centerX, 30 )
ssk.labels:quickLabel( group, "quick label #2", centerX, 60, testFont, 24, _BRIGHTORANGE_ )
ssk.labels:quickLabel( group, "quick label #3", centerX, 90, testFont2, 32, ssk.ggcolor:fromName( "PowderBlue", true ) )
