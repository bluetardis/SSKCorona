...
local html = require "samples.askEd.mlText.mltext.html"

-- GlitchGames/GGColour
-- https://github.com/GlitchGames/GGColour
local ggcolor = require "samples.askEd.mlText.mltext.GGColour"
local colorChart = ggcolor:new()
colorChart:loadColours( "samples/askEd/mlText/mltext/otherRGB.json" )
