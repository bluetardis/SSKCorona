...
addInterfaceElements = function()
	...
	gameLabel = ssk.labels:presetLabel( layers.interfaces, "default", "Tic-Tac-Toe", centerX, h - 20, { fontSize = 24 } )
...
createBoard = function ( group, x, y, tileSize, rows, cols, tileBuilder, tileTouchCB )
	...
	function aBoard:dropTile( gx, gy )
		local theTile = self[gx + (gy - 1) * self.maxX]
