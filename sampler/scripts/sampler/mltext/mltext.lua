...
local html = require "scripts.sampler.mltext.html"

-- GlitchGames/GGColour
-- https://github.com/GlitchGames/GGColour
local ggcolor = require "scripts.sampler.mltext.GGColour"
local colorChart = ggcolor:new()
colorChart:loadColours( "scripts/sampler/mltext/otherRGB.json" )
