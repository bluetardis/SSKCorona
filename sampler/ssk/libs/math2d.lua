...
s ssk.math2d.scale( ..., scale [ , altRet ])
...
d <br>Warning: These are not calulated in the trasitional cartesian/polar -space.
s ssk.math2d.angle2Vector( angle [ , altRet ])
