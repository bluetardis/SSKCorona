...
-- ============================
local params = table.shallowCopy(default_params)
params.unselImgSrc 			= imagePath .. "credits.png"
params.selImgSrc 			= imagePath .. "credits.png"
mgr:addButtonPreset( "fastpack_credits", params )

-- ============================
-- ======= Credits Button
-- ============================
local params = table.shallowCopy(default_params)
params.unselImgSrc 			= imagePath .. "help.png"
params.selImgSrc 			= imagePath .. "help.png"
mgr:addButtonPreset( "fastpack_help", params )
