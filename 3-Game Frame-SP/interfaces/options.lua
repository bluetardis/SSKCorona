...
addInterfaceElements = function( )
	...
	--if(system.orientation == "portrait") then		
		...
		curY = curY + 50
		objs.effectsEnableToggle = ssk.buttons:presetToggle( layers.interfaces, "defaultcheck", 60, curY, 30, 30, "", ssk.sbc.tableToggler_CB )
		...
		-- Music On/Off Toggle
		curY = curY + 50
		objs.musicEnableToggle = ssk.buttons:presetToggle( layers.interfaces, "defaultcheck", 60, curY, 30, 30, "", ssk.sbc.tableToggler_CB )
