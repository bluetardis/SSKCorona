...
r None.
--]]
function displayBuilders.line( group, startX, startY, endX, endY, dashLen, gapLen, visualParams )
...
r None.
--]]
function displayBuilders.line2( group, startX, startY, angle, length, dashLen, gapLen, visualParams )
	local endX, endY = ssk.math2d.angle2Vector( angle )
	endX, endY = ssk.math2d.scale( endX, endY, length )
	endX, endY = ssk.math2d.add(startX, startY, endX, endY)
	return displayBuilders.line( group, startX, startY, endX, endY, dashLen, gapLen, visualParams )
end
